...
from sage.domains.gym_nle.envs import hungry

"""
This is a modified copy of tasks.py from minihack/agent/common/envs. It allows us to add our own custom minihack environments without forking the minihack repo
"""
...
ENVS = dict(
    ...
    # Hungry 
    hungry = hungry.MiniHackHungry1,
    hungry_rooms = hungry.MiniHackHungry5,
    hungry_fixed3 = hungry.MiniHackHungryFixed3,
    hungry_fixed5 = hungry.MiniHackHungryFixed5,
    hungry_danger5 = hungry.MiniHackHungryDanger5
