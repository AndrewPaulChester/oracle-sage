...
import sage.forks.stable_baselines3.stable_baselines3
from sage.forks.stable_baselines3.stable_baselines3.common.type_aliases import TensorDict
...
def save_to_zip_file(
    ...
    with zipfile.ZipFile(save_path, mode="w") as archive:
        ...
        archive.writestr("_stable_baselines3_version", sage.forks.stable_baselines3.stable_baselines3.__version__)
