...
from sage.domains.utils.spaces import Autoregressive, NodeAction
...
def make_proba_distribution(
    ...
    elif isinstance(action_space, Autoregressive):
        return CategoricalDistribution(action_space.spaces[-1].n, **dist_kwargs)
